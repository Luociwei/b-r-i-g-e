...
if __name__ == '__main__':
    ...
    table_data = [['xxxxy', 8, 1, 4, 4, 4, 4,4],['yy_y',8, 1, 3, 2, 5,6,4]]
    # table_category_data = [[['CWNJ_00000_FCT', '#0000FF', 'x_x', 8, 1, 1.1, 1.2, 1.3, 1.4,1.5],['CWNJ_0_FCT', '#0000FF', 'x_x', 8, 1, 2.1, 2.2, 2.3]],[['CWNJ_11111_FCT', '#FF0000', 'y_y', 8, 1, 6.1, 6.2, 6.3, 6.4,6.5],['CWNJ_11111_FCT', '#FF0000', 'y_y', 8, 1, 7.1, 7.2, 7.3]]]
    table_category_data = []#it's empty when color_by == 'Off'
