...
-(NSView *)tableView:(NSTableView *)tableView viewForTableColumn:(NSTableColumn *)tableColumn row:(NSInteger)row
{
    ...
    //Tech Tag','Coverage Tag','Column_2b','SUBSUBTESTNAME','Item Cycle Time (ms)','Coverage Tag Cycle Time (ms)','Tech Tag Cycle Time (ms)
    
    if ([columnIdentifier isEqualToString:@"TechTag"])
    {
        index = 0;
    ...
    else if ([columnIdentifier isEqualToString:@"CoverageTag"])
    {
        index = 1;
    ...
    else if ([columnIdentifier isEqualToString:@"Column_2b"])
    {
        index = 2;
    ...
    else if ([columnIdentifier isEqualToString:@"ItemCycleTime(ms)"])
    {
        index = 4;
