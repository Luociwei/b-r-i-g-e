...
@interface SCDragViewChild () {
    NSTrackingRectTag trackingRectTag;
    BOOL mouseInside;
}

@property NSPoint lastDragLocation;
@property NSPoint currentDragLocation;
@end

@implementation SCDragViewChild
...
- (void)mouseDown:(NSEvent *) e {
    ...
    if (!dragging) {
        ...
        self.currentDragLocation =  [self.superview convertPoint:[e locationInWindow] fromView:nil];
...
//{
//    NSLog(@"-----myCustomViewAboveSiblingViewsComparator");
...
- (void)mouseDragged:(NSEvent *)theEvent
{
    ...
    if (dragging) {
        ...
        //NSLog(@"--->>>newDragLocation: %f %f,  %f %f",newDragLocation.x,newDragLocation.y,thisOrigin.x,thisOrigin.y);
        ...
        self.currentDragLocation = thisOrigin;
...
-(void)mouseUp:(NSEvent *)theEvent {
    ...
    if (dragging) {
        ...
        [self setFrameOrigin:self.currentDragLocation];
        //[self.parentView stopDragForView:self];
